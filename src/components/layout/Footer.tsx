  ...
  return (
    <footer className="relative isolate w-full overflow-hidden border-t border-border">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20 md:py-28">
        ...
        <div className="mt-16 flex flex-col items-start justify-between gap-3 border-t border-border pt-6 font-mono text-[12px] uppercase tracking-[0.25em] text-muted-foreground md:flex-row md:items-center">
          <span>© 2026 Rohit Kumar — All rights reserved.</span>
        </div>
      </div>
    </footer>
  );
